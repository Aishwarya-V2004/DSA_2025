...
public class PeakElementFinder {
    public int PeakElementFinder(int[] nums) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Peak Index : " + finder.PeakElementFinder(nums1)); // Output: 2
        System.out.println("Peak Index : " + finder.PeakElementFinder(nums2)); // Output: 1 or 5
    }
}
