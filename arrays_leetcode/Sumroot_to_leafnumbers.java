...
public class Sumroot_to_leafnumbers {
    ...
    public static void main(String[] args) {
        ...
        Sumroot_to_leafnumbers sol = new Sumroot_to_leafnumbers();
        System.out.println("Sum for tree 1: " + sol.sumNumbers(root1)); // Output: 25
        System.out.println("Sum for tree 2: " + sol.sumNumbers(root2)); // Output: 1026
    }
}
