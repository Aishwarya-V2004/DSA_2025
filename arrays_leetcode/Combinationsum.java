...
public class Combinationsum {
    ...
    private void backtrack(int[] candidates, int target, int startIndex, List<Integer> current, List<List<Integer>> result) {
        if (target == 0) {
        ...
        for (int i = startIndex; i < candidates.length; i++) {
            ...
            // Allow same element again, so pass 'i' instead of 'i+1'
    ...
    public static void main(String[] args) {
        ...
        int[] candidates3 = {2};
        int target3 = 1;
        System.out.println(sol.combinationSum(candidates3, target3));
    }
}
